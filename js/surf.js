...
document.getElementById('php').onclick = function php() {
    ...
    if (youtube) {
        ...
        var gui = "https://" + domainPHP + "/geographic/index.php?q=" + "http://" + url;
    }
...
function startpagekey() {
    document.getElementById("url").value = "startpage.com";
}

function andkonkey() {
    document.getElementById("url").value = "andkon.com";
}

function youtubekey() {
    document.getElementById("url").value = "youtube.com";
}
