...
function is_url(str) {
  ...
  if (regexp.test(str)) {
    ...
    var googleurl =
        "https://" + domainPHP +
        "/geographic/index.php?q=https://google.com/search?q=" + url;
...
document.getElementById("php").onclick = function php() {
  ...
  if (youtube) {
    ...
    var gui = "https://" + domainPHP + "/geographic/index.php?q=" +
              "http://" + url;
  }
  document.write(
      '<iframe allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" oallowfullscreen="true" msallowfullscreen="true" id="proxyframe" src="' +
...
window.onload = function() { $("url").focus(); };
